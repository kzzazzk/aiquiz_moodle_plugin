...
class mod_aiquiz_renderer extends \plugin_renderer_base {
    /**
    ...
    public function review_summary_table($summarydata, $page) {
        ...
        foreach ($summarydata as $rowdata) {
            ...
            $output .= html_writer::tag('tr',
                renderer . phphtml_writer::tag('th', $title, array('class' => 'cell', 'scope' => 'row')) .
    ...
    protected function render_quiz_nav_question_button(quiz_nav_question_button $button) {
        ...
        $tagcontents = renderer . phphtml_writer::tag('span', '', array('class' => 'thispageholder')) .
    ...
    public function quiz_notices($messages) {
        ...
        return $this->notification(
            renderer . phphtml_writer::tag('p', get_string('accessnoticesheader', 'quiz')) . $this->access_messages($messages),
            'warning',
            false
        );
    }
     ...
     * @param mod_aiquiz_view_object $viewobj
     ...
     *
     * @param mod_aiquiz_view_object $viewobj the information required to display the view page.
     * @return string HTML to output.
     */
    public function view_page_tertiary_nav(mod_aiquiz_view_object $viewobj): string {
        $content = '';
     ...
     * @return string HTML to output.
     */
    public function view_page_buttons(mod_aiquiz_view_object $viewobj) {
        $output = '';
    ...
    public function attempt_state($attemptobj) {
        switch ($attemptobj->get_state()) {
            ...
            case quiz_attempt::OVERDUE:
                return renderer . phpget_string('stateoverdue', 'quiz') . html_writer::tag('span',
                        get_string('stateoverduedetails', 'quiz',
                            userdate($attemptobj->get_due_date())),
                        array('class' => 'statedetails'));

            case quiz_attempt::FINISHED:
                return renderer . phpget_string('statefinished', 'quiz') . html_writer::tag('span',
    ...
    public function connection_warning() {
        ...
        return renderer . phphtml_writer::tag('div', $warning,
...
class mod_aiquiz_links_to_other_attempts implements renderable {
    /**
